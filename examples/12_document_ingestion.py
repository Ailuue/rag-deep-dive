"""
Example 12 — document ingestion: from messy sources to clean, structured chunks.
================================================================================
...
This script shows three ingestion ideas you can apply to real corpora:
  ...
  1. STRUCTURE-AWARE CHUNKING. Instead of a blind sliding window, split on the
     document's own headings. Each section becomes a chunk that's about one thing,
     and its heading becomes metadata — so retrieval can cite "Billing > Refunds."
...
# --- 1. Structure-aware chunking: split Markdown on headings -----------------
def split_markdown_sections(text: str) -> list[tuple[str, str]]:
    """Return (heading, body) sections, splitting on Markdown `#`/`##`/... lines."""
